...
export default function GuidePage() {
  return (
    <div className="space-y-10">
      ...
      <nav className="flex flex-wrap gap-x-4 gap-y-1 rounded-lg border border-ink-100 bg-white p-4 text-sm">
        {SECTIONS.map((s) => (
      ...
      <section id="running-an-intake" className="space-y-3 scroll-mt-6">
        ...
        <ol className="grid gap-2 pl-0 text-sm sm:grid-cols-2">
          {INTAKE_AREAS.map((area, i) => (
            <li key={area.id} className="rounded-md border border-ink-100 bg-white p-3">
