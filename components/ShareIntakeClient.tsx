  ...
  if (!respondentKnown) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-lg font-semibold text-slate-900">Sourcing CoPilot</h1>
        ...
        <form onSubmit={handleStart} className="space-y-4 rounded-lg border border-slate-200 bg-white p-5">
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700">Your email (optional)</label>
            <input
              type="email"
              value={email}
